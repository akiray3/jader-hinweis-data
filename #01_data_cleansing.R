...
tmp10 <- gsub(pattern = "カプセル",replacement = "不明", x = tmp9)
tmp11 <- gsub(pattern = "フィルム",replacement = "不明", x = tmp10)
tmp12 <- gsub(pattern = "ゼリー",replacement = "不明", x = tmp11)
tmp13 <- gsub(pattern = "細粒",replacement = "不明", x = tmp12)
tmp14 <- gsub(pattern = "注射剤",replacement = "不明", x = tmp13)
tmp15 <- gsub(pattern = "外用薬",replacement = "不明", x = tmp14)
tmp16 <- gsub(pattern = "外用剤",replacement = "不明", x = tmp15)
cat(paste0(sum(tmp16 != tmp9),"件の剤形を削除しました"), fill = TRUE)
tmp17 <- gsub(pattern = "塩酸塩",replacement = "不明", x = tmp16)
tmp18 <- gsub(pattern = "塩酸",replacement = "不明", x = tmp17)
tmp19 <- gsub(pattern = "シュウ酸塩",replacement = "不明", x = tmp18)
tmp20 <- gsub(pattern = "ナトリウム水和物炭酸水素ナトリウム",replacement = "不明", x = tmp19)
tmp21 <- gsub(pattern = "ナトリウム水和物Lグルタミン",replacement = "不明", x = tmp20)
tmp22 <- gsub(pattern = "ナトリウムLグルタミン",replacement = "不明", x = tmp21)
tmp23 <- gsub(pattern = "ナトリウム水和物",replacement = "不明", x = tmp22)
tmp24 <- gsub(pattern = "ナトリウム水和物",replacement = "不明", x = tmp23)
tmp25 <- gsub(pattern = paste0("遺伝子組換え","[1-3]"), replacement = "遺伝子組み換え", x = tmp24)
tmp26 <- gsub(pattern = "遺伝子組換え注", replacement = "遺伝子組み換え", x = tmp25)
tmp27 <- gsub(pattern = "安息香酸エステル", replacement = "不明", x = tmp26)
