...
org <- purrr::map(
    .x = fnames,
    .f = function(x){
      xpath <- paste0("#01_cleansed_data/", x,".csv")
...
demo2 <- demo %>% 
    ...
    print()
write.csv(x = demo2, file = "#02_analysis_data/demo.csv", fileEncoding = "CP932", row.names = FALSE)
saveRDS(object = demo2, file = "#03_application_data/demo.obj")
...
write.csv(x = drug2, file = "#02_analysis_data/drug.csv", fileEncoding = "CP932", row.names = FALSE)
saveRDS(object = drug2, file = "#03_application_data/drug.obj")
...
write.csv(x = drug_summary, file = "#02_analysis_data/drug_summary.csv", fileEncoding = "CP932", row.names = FALSE)
saveRDS(object = drug_summary, file = "#03_application_data/drug_summary.obj")
...
write.csv(x = reac2, file = "#02_analysis_data/reac.csv", fileEncoding = "CP932", row.names = FALSE)
saveRDS(object = reac2, file = "#03_application_data/reac.obj")
...
write.csv(x = reac_summary, file = "#02_analysis_data/reac_summary.csv", fileEncoding = "CP932", row.names = FALSE)
saveRDS(object = reac_summary, file = "#03_application_data/reac_summary.obj")
